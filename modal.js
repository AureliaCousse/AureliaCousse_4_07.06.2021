...
closeBtn.forEach((btn) => btn.addEventListener('click', closeModal)); //closeBtn, btn, closeModal: new names given to elements to create function
...
myForm.addEventListener('submit', function (e) {
  ...
  if (!checkbox1.checked) {   /*attend true ou false donc pas besoin de mettre ==*/
    ...
    removeError(checkbox1, checkbox1Error)
  }

  /* To send form and get a confirmation message*/
...
/**
 * Show Error message
 * @param {*} input: champs rempli par le user
 * @param {*} error: ligne contenant les message d'erreur si saisie du user erronée
 * @param {*} errorMessage : message d'erreur lui-même
 */
